...
import FeaturedWebsitesBrowser from "@/components/FeaturedWebsitesBrowser";
  ...
  return (
    <div className="home" style={{position: 'relative'}}>
      ...
      <section className="hero">
        <h3>
         My name is Camila <span className="emoji">m</span>
          {/* <img className="hi" src={hi.src}/> */}
        </h3>
      ...
      <FeaturedWebsitesBrowser projects={featuredWebsites} />
